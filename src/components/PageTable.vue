<template>
    <section class="k-pagetable-section">
        <header class="k-section-header">
            ...
            <k-button-group>
                <button v-if="showReset" class="pagetable-reset-button" @click="resetTable" v-html="translations.reset"></button>
                <input v-if="showSearch" class="pagetable-search-input" type="text" v-model="searchTerm" :placeholder="translations.filter">
