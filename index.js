...
exports.VueGoodTable = exports.default = void 0;
...
var nonEnumShadows = !propertyIsEnumerable$1.call({
  'valueOf': 1
}, 'valueOf');
/**
 * Creates an array of the enumerable property names of the array-like `value`.
...
var _default2 = VueGoodTablePlugin;
exports.default = _default2;
},{"buffer":"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"components/PageTable.vue":[function(require,module,exports) {
"use strict";
...
var _vueGoodTable = require("vue-good-table");
...
var _default = {
  ...
  components: {
    VueGoodTable: _vueGoodTable.VueGoodTable
  },
  data: function data() {
    return {
      columns: [],
  ...
  computed: {
    ...
    showSearch: function showSearch() {
      return this.columns.filter(function (el) {
        return el.globalSearchDisabled == false;
      }).length > 0 && this.options.search && this.rows.length;
    },
  ...
  methods: {
    replaceInvalidDate: function replaceInvalidDate(str) {
      return str.replace('Invalid Date', '-');
    },
    load: function load(reload) {
      var _this = this;

      if (!reload) this.isLoading = true;
      this.$api.get(this.parent + "/sections/" + this.name).then(function (response) {
        _this.isLoading = false;
        _this.options = response.options;
        _this.columns = response.data.columns;
        _this.rows = _this.items(response.data.rows); // replace default translations if needed

        var translations = response.translations;
        Object.keys(translations).forEach(function (k) {
          if (translations[k] == null) delete translations[k];
        });
        _this.translations = Object.assign({}, _this.translations, translations);
      }).catch(function (error) {
        _this.isLoading = false;
        _this.error = error.message;
      });
    },
    openRef: function openRef(id) {
      this.$refs[id].toggle();
    },
    ...
    checkReset: function checkReset() {
      this.showReset = this.rows.length && (this.searchTerm.length > 0 || // if table is searched
    ...
    loadStoredState: function loadStoredState() {
      var storedState = JSON.parse(sessionStorage.getItem(this.storeName));
    ...
    storeCurrentState: function storeCurrentState() {
      if (this.$refs['table']) {
        var currentState = {};
        currentState.page = {
    ...
    resetTable: function resetTable() {
      // reset sorting
      this.$refs['table'].changeSort([]); // remove sorting classes

      var sorted = document.querySelectorAll('.sorting');
      ...
      this.searchTerm = ''; // reset currentPerPage

      this.$refs['table'].currentPerPage = this.options.limit;
      this.$refs['table'].perPage = this.options.limit; // go to first page

      this.$refs['table'].changePage(1); // store current state
...
exports.default = _default;
        var $5121bf = exports.default || module.exports;
      
      if (typeof $5121bf === 'function') {
        $5121bf = $5121bf.options;
      }
    
        /* template */
        Object.assign($5121bf, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "section",
    { staticClass: "k-pagetable-section" },
    [
      _c(
        "header",
        { staticClass: "k-section-header" },
        [
          _c("k-headline", { attrs: { link: _vm.options.link } }, [
            _vm.isLoading
              ? _c("span", [_vm._v("…")])
          ...
          _c(
            ...
            [
              _vm.showReset
                ? _c("button", {
                    staticClass: "pagetable-reset-button",
                    domProps: { innerHTML: _vm._s(_vm.translations.reset) },
              ...
              _vm.showSearch
                ? _c("input", {
                    ...
                    staticClass: "pagetable-search-input",
                    attrs: {
                      type: "text",
                      placeholder: _vm.translations.filter
                    },
              ...
              _vm.add
                ? _c(
                    "k-button",
                    { attrs: { icon: "add" }, on: { click: _vm.create } },
      ...
      _vm.rows.length && !_vm.isLoading
              ...
              [
                {
                  ...
                  fn: function(props) {
                    return [
                      ...
                      _vm.options.showImage
                        ? _c(
                            "span",
                            [
                              _c("k-link", { attrs: { to: props.row.link } }, [
                                _c(
                                  "figure",
                                    ...
                                    props.row.image && props.row.image.url
                                      ? _c("k-image", {
                                          attrs: {
                                            ...
                                            back:
                                              props.row.image.back || "pattern",
                                            cover: props.row.image.cover
                                          }
                                        })
                                      : _c(
                                          "k-icon",
                        ...
                        : props.column.field == "p-options" && _vm.showOptions
                        ? _c("span", [
                            _c(
                              "div",
                              ...
                              [
                                _vm._t("options", [
                                  props.row.flag && _vm.options.showStatus
                                    ? _c(
                                        "k-status-icon",
                                        _vm._b(
                                    ...
                                    : _vm._e(),
                                  _vm._v(" "),
                                  props.row.options && _vm.options.showActions
                                    ? _c("k-button", {
                                    ...
                                    : _vm._e(),
                                  _vm._v(" "),
                                  _vm.options.showActions
                                    ? _c("k-dropdown-content", {
                                        ref:
                                          "dropdown-" + props.row.originalIndex,
                                        attrs: {
                                        ...
                                        on: {
                                          action: function($event) {
                                            return _vm.action(props.row, $event)
                                          }
                                        }
                                      })
                                    : _vm._e()
                        ...
                        : _c("k-link", {
                            attrs: { to: props.row.link },
                            domProps: {
                              innerHTML: _vm._s(
                                _vm.replaceInvalidDate(
        ...
        ? _c(
            ...
            [
              _c(
                "k-empty",
                {
                  attrs: { layout: _vm.options.layout, icon: "backupsLoader" }
                },
                [
                  _vm._v(
                    "\n            " +
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("k-page-create-dialog", { ref: "create" }),
      _vm._v(" "),
      _c("k-page-duplicate-dialog", { ref: "duplicate" }),
      _vm._v(" "),
      _c("k-page-rename-dialog", {
        ref: "rename",
        on: { success: _vm.update }
      }),
      _vm._v(" "),
      _c("k-page-sort-dialog", { ref: "sort", on: { success: _vm.update } }),
      _vm._v(" "),
      _c("k-page-status-dialog", {
        ref: "status",
        on: { success: _vm.update }
      }),
      _vm._v(" "),
      _c("k-page-template-dialog", {
        ref: "template",
        on: { success: _vm.update }
      }),
      _vm._v(" "),
      _c("k-page-remove-dialog", { ref: "remove", on: { success: _vm.update } })
    ],
    2
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5121bf', $5121bf);
          } else {
            api.reload('$5121bf', $5121bf);
          }
        }
...
var _PageTable = _interopRequireDefault(require("./components/PageTable.vue"));
...
},{"./components/PageTable.vue":"components/PageTable.vue"}],"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
